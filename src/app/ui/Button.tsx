...
const Button = ({
    ...
    const baseStyles = "inline-flex items-center justify-center font-semibold text-white rounded-sm transition-all active:scale-95 disabled:opacity-50 disabled:pointer-events-none";
